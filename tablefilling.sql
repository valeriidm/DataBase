...
INSERT INTO staff (id, fname,lname, bdate, email, address, zip, phone, SSN, posid, qualid, hospid )
VALUES (1, 'John F.', 'Gilbert', 'January 8 1961',  'JohnFGilbert@teleworm.us', '96 Rue de la Gauchetière E Montreal', 'L1H 7K5',  '905-431-1311', '673 747 515', 1, 1, 1);

INSERT INTO staff (fname,lname, bdate, email, address, zip, phone, SSN, posid, qualid, hospid )
VALUES ('Robert J.', 'Moore', 'April 24 1945' ,  'RobertJMoore@dayrep.com' , '3708 Avenue Henri Julien Montreal', 'V2S 2H7' ,  '604-853-8638', '366 987 444', 1, 1, 2 );

INSERT INTO staff (fname,lname, bdate, email, address, zip, phone, SSN, posid, qualid, hospid )
VALUES ('Shirley', 'Minor', 'November 14 1967'  ,  'ShirleyJMinor@armyspy.com', '4293 Avenue de Esplanade Montreal' , 'T5J 2R4' ,  '780-996-5578', '726 768 716', 2, 2, 1);

INSERT INTO staff (fname,lname, bdate, email, address, zip, phone, SSN, posid, qualid, hospid )
VALUES ('Lane W.', 'Bentley', 'January 18 1965' ,  'LaneWBentley@rhyta.com' , '252 Ch de la Côte-Sainte-Catherine Montreal', 'P0T 2L0'  ,  '807-349-5758', '090 601 576', 3, 1, 3);

INSERT INTO staff (fname,lname, bdate, email, address, zip, phone, SSN, posid, qualid, hospid )
VALUES ('Drew B.', 'Dalley', 'December 23 1971',  'DrewBDalley@dayrep.com ', '444 Avenue Champagneur Montreal ', 'M4W 1J7' ,  '416-318-8430', '521 398 032', 3, 3, 3);

INSERT INTO staff (fname,lname, bdate, email, address, zip, phone, SSN, posid, qualid, hospid )
VALUES ('Frank I.', 'Sims', 'July 27 1980' ,  'FrankISims@armyspy.com' , '274 67e Av Laval' , 'V7L 2C1' ,  '604-960-7790', '709 809 909', 1, 3, 4);
